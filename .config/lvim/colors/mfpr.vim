...
let s:keyword_color = "#d7ae38" " Customizable keyword color

if &t_Co >= 256 || has("gui_running")
    hi Normal         ctermbg=0  ctermfg=15   cterm=NONE      guibg=#030303 guifg=#c5beba gui=NONE
    ...
    hi Constant       ctermbg=bg ctermfg=5    cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi Character      ctermbg=bg ctermfg=5    cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi Error          ctermbg=8  ctermfg=1    cterm=NONE      guibg=#645d59 guifg=#be503e gui=NONE
    hi Identifier     ctermbg=bg ctermfg=14   cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi Function       ctermbg=bg ctermfg=2    cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    ...
    hi Include        ctermbg=bg ctermfg=4    cterm=NONE      guibg=bg      guifg=#d7ae38 gui=NONE
    hi Define         ctermbg=bg ctermfg=1    cterm=NONE      guibg=bg      guifg=#be503e gui=NONE
    hi Macro          ctermbg=bg ctermfg=13   cterm=NONE      guibg=bg      guifg=#d7ae38 gui=NONE
    hi PreCondit      ctermbg=bg ctermfg=13   cterm=bold      guibg=bg      guifg=#d7ae38 gui=bold
    ...
    hi Tag            ctermbg=bg ctermfg=9    cterm=bold      guibg=bg      guifg=#030303 gui=bold
    ...
    hi Debug          ctermbg=bg ctermfg=9    cterm=NONE      guibg=bg      guifg=#030303 gui=NONE
    hi Statement      ctermbg=bg ctermfg=1    cterm=NONE      guibg=bg      guifg=#be503e gui=NONE
    hi Conditional    ctermbg=bg ctermfg=4    cterm=NONE      guibg=bg      guifg=#d7ae38 gui=NONE
    hi Repeat         ctermbg=bg ctermfg=4    cterm=NONE      guibg=bg      guifg=#d7ae38 gui=NONE
    hi Label          ctermbg=bg ctermfg=4    cterm=NONE      guibg=bg      guifg=#d7ae38 gui=NONE
    hi Operator       ctermbg=bg ctermfg=14   cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi Exception      ctermbg=bg ctermfg=14   cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi Keyword        ctermbg=bg ctermfg=3    cterm=NONE      guibg=bg      guifg=#d7ae38 gui=NONE
    hi String         ctermbg=bg ctermfg=6    cterm=NONE      guibg=bg      guifg=#008000 gui=NONE
    hi Number         ctermbg=bg ctermfg=5    cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi Float          ctermbg=bg ctermfg=5    cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi Boolean        ctermbg=bg ctermfg=12   cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi Todo           ctermbg=bg ctermfg=2    cterm=bold      guibg=bg      guifg=#7bb292 gui=bold
    hi Type           ctermbg=bg ctermfg=11   cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi StorageClass   ctermbg=bg ctermfg=5    cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi Structure      ctermbg=bg ctermfg=11   cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi Typedef        ctermbg=bg ctermfg=11   cterm=NONE      guibg=bg      guifg=NONE gui=NONE
    hi Underlined     ctermbg=bg ctermfg=11   cterm=underline guibg=bg      guifg=NONE gui=underline
    ...
    hi VisualNOS      ctermbg=0  ctermfg=8    cterm=bold      guibg=#030303 guifg=#645d59 gui=bold
    hi Pmenu          ctermbg=8  ctermfg=14   cterm=NONE      guibg=#645d59 guifg=#a8c1c5 gui=NONE
    hi PmenuSbar      ctermbg=8  ctermfg=0    cterm=NONE      guibg=#645d59 guifg=#030303 gui=NONE
    hi PmenuSel       ctermbg=14 ctermfg=0    cterm=NONE      guibg=#a8c1c5 guifg=#030303 gui=NONE
    hi PmenuThumb     ctermbg=10 ctermfg=0    cterm=NONE      guibg=#9ad1bc guifg=#030303 gui=NONE
    ...
    hi DiffAdd        ctermbg=10 ctermfg=0    cterm=bold      guibg=#9ad1bc guifg=#030303 gui=bold
    hi DiffChange     ctermbg=11 ctermfg=0    cterm=NONE      guibg=#d7ae38 guifg=#030303 gui=NONE
    hi DiffDelete     ctermbg=13 ctermfg=8    cterm=bold      guibg=#e7c6be guifg=#645d59 gui=bold
    hi DiffText       ctermbg=9  ctermfg=0    cterm=bold      guibg=#030303 guifg=#030303 gui=bold
    hi IncSearch      ctermbg=15 ctermfg=4    cterm=bold      guibg=#c5beba guifg=#628b97 gui=bold
    hi Search         ctermbg=12 ctermfg=0    cterm=NONE      guibg=#bad4f5 guifg=#030303 gui=NONE
    hi Directory      ctermbg=bg ctermfg=14   cterm=bold      guibg=bg      guifg=#a8c1c5 gui=bold
    hi MatchParen     ctermbg=8  ctermfg=9    cterm=bold      guibg=#645d59 guifg=#030303 gui=bold
    hi SpellBad       ctermbg=bg ctermfg=NONE cterm=undercurl guibg=bg      guifg=NONE    gui=undercurl guisp=#030303
    ...
    hi Cursor         ctermbg=14 ctermfg=0    cterm=bold      guibg=#a8c1c5 guifg=#030303 gui=bold
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi Float          ctermbg=black    ctermfg=darkmagenta cterm=NONE
    ...
    hi DiffAdd        ctermbg=bg       ctermfg=black       cterm=bold
    hi DiffChange     ctermbg=bg       ctermfg=black       cterm=NONE
    hi DiffDelete     ctermbg=bg       ctermfg=darkgray    cterm=bold
    hi DiffText       ctermbg=bg       ctermfg=black       cterm=bold
...
if $NVIM_TUI_ENABLE_TRUE_COLOR == 1
  ...
  let g:terminal_background =  "#030303"
  let g:terminal_color_0 =     "#030303"
  ...
  let g:terminal_color_9 =     "#030303"
  let g:terminal_color_10 =    "#9ad1bc"
  let g:terminal_color_11 =    "#d7ae38"
